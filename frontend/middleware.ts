...
export function middleware(request: NextRequest) {
  ...
  // real domain ranks. Crawlers can still fetch/render, so GSC "Test Live URL"
  // and URL Inspection work for validation. Flip this off (or just launch the
  // apex) when you're ready to let the real domain be indexed.
  if (isBetaOrDev) {
