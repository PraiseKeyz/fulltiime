...
const MATCHES: MatchRow[] = [
  ...
  { id: '7',  comp: 'PL',  compColor: COMP_COLORS.PL,  homeTeam: 'Man United',   homeLogo: '', awayTeam: 'Aston Villa',      awayLogo: '', homeScore: null, awayScore: null, status: 'UPCOMING', kickoff: '20:00' },
  { id: '8',  comp: 'LL',  compColor: COMP_COLORS.LL,  homeTeam: 'Atletico',     homeLogo: '', awayTeam: 'Sevilla',          awayLogo: '', homeScore: null, awayScore: null, status: 'UPCOMING', kickoff: '21:00' },
  { id: '9',  comp: 'EL',  compColor: COMP_COLORS.EL,  homeTeam: 'Roma',         homeLogo: '', awayTeam: 'Ajax',             awayLogo: '', homeScore: null, awayScore: null, status: 'UPCOMING', kickoff: '21:00' },
  { id: '10', comp: 'SA',  compColor: COMP_COLORS.SA,  homeTeam: 'Juventus',     homeLogo: '', awayTeam: 'Atlético Madrid',  awayLogo: '', homeScore: 2,    awayScore: 0,    status: 'FINISHED' },
  { id: '11', comp: 'BUN', compColor: COMP_COLORS.BUN, homeTeam: 'Leverkusen',   homeLogo: '', awayTeam: 'Stuttgart',        awayLogo: '', homeScore: 1,    awayScore: 1,    status: 'FINISHED' },
  { id: '12', comp: 'PL',  compColor: COMP_COLORS.PL,  homeTeam: 'Arsenal',      homeLogo: '', awayTeam: 'Newcastle',        awayLogo: '', homeScore: 3,    awayScore: 1,    status: 'FINISHED' },
]
...
function MatchRow({ match }: { match: MatchRow }) {
  return (
    ...
    >
      <span className="text-[10px] font-black uppercase w-8 shrink-0" style={{ color: match.compColor }}>
        {match.comp}
      </span>
    ...
    <>
      ...
      <div className="bg-[#111111] dark:bg-[#111111] border-b border-border py-6">
        <div className="mx-auto max-w-[1400px] px-4 lg:px-6">
          ...
          <p className="text-[13px] text-[#888]">Scores and fixtures from across football</p>

          {/* Date navigator + filters row */}
          <div className="flex items-center justify-between mt-5 gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-full border border-border text-muted-foreground hover:text-foreground hover:border-muted-foreground transition-colors"
              >
                <ChevronLeft className="h-4 w-4" />
              </button>
              <span className="text-[13px] font-bold text-white min-w-[80px] text-center">
      ...
      <div className="mx-auto max-w-[1400px] px-4 lg:px-6 py-6 space-y-8">
        ...
        {!showLive && !showUpcoming && !showFinished && (
