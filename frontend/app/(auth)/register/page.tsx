...
export default function RegisterPage() {
  ...
  const soon = () => toast('Coming soon', { description: 'This sign-up option isn’t available yet.' })
    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-gradient-to-br from-[#04140c] via-[#06371f] to-[#0a5c34] p-12 text-white">
        ...
        <div
          ...
          style={{ backgroundImage: "url('/auth-stadium.jpg')" }}
        />
      ...
      <div className="flex items-center justify-center bg-zinc-100 px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <h2 className="text-4xl font-black uppercase tracking-tight text-zinc-900">Create account</h2>
          <p className="mt-2 text-[14px] text-zinc-500">Sign up in seconds. No credit card required.</p>
