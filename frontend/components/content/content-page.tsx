...
export function ContentPage({
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 lg:px-6 py-12">
      <h1 className="font-inter text-3xl font-black tracking-tight text-foreground">{title}</h1>
      ...
      <div
        className={
          ...
          '[&_h2]:mb-2 [&_h2]:font-inter [&_h2]:text-lg [&_h2]:font-bold [&_h2]:text-foreground ' +
          '[&_p]:mt-2 [&_p]:font-inter [&_a]:text-primary [&_a]:underline ' +
