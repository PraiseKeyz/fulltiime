...
function HeroSkeleton() {
  return (
    <section className="">
      <div className="mx-auto max-w-[var(--content-max)] px-4 lg:px-6 py-4 grid gap-4 lg:grid-cols-[280px_1fr_280px]">
...
export function HeroSection() {
  ...
  return (
    <section className="">
      <div className="mx-auto max-w-[var(--content-max)] px-4 lg:px-6 grid gap-4 lg:grid-cols-[280px_1fr_280px]">
